...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title="Total Success Launch at " + entered_site)
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    df_scope = df[(df['Payload Mass (kg)']>=low)&(df['Payload Mass (kg)']<=high)]
    fig = px.scatter(df_scope,
                    x='Payload Mass (kg)',
                    y='class',
                    color='Booster Version Category',
                    title="Correlation between Payload and Success from "+entered_site)
    return fig
